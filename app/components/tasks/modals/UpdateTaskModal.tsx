                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <div className="relative">
                                    <select
                                        ...
                                        className="w-full appearance-none rounded-xl border border-input bg-transparent pl-10 pr-10 py-3 text-sm focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
                                    >
                                    ...
                                    <div className="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2">
                                        <div className={`h-3 w-3 rounded-full ${formData.priority === 'low' ? 'bg-green-500' : formData.priority === 'high' ? 'bg-red-500' : 'bg-orange-400'}`}></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <div className="relative">
                                    <select
                                        ...
                                        disabled={loading}
                                        className="w-full appearance-none rounded-xl border border-input bg-transparent pl-10 pr-10 py-3 text-sm focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary disabled:opacity-50"
                                    >
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex flex-1 items-center gap-2">
                                        ...
                                        <input
                                            ...
                                            className="flex-1 w-full rounded-xl border border-input bg-transparent px-4 py-3 text-sm text-foreground focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
                                        />
                                    </div>
                                </div>
